...
Sparkling Companion is a companion plugin for Sparkling WordPress theme by Colorlib.com.
== Description ==

Sparkling Companion is a companion for Sparkling One Page WordPress theme by Colorlib.com. This plugin won't do anything for other free or premium WordPress themes and you need to download and install <a href="https://colorlib.com/wp/themes/sparkling/" target="_blank">Sparkling</a>. If you are having problems with Sparkling theme or its companion plugin the fastest way to receive help is via our theme <a href="https://colorlib.com/wp/forums" target="_blank">support forum</a>.
...
While Sparkling is a great one page WordPress theme it might not be for everyone therefore you might want to check other free <a href="https://colorlib.com/wp/themes/" target="_blank">WordPress themes</a> that are created by Colorlib.
...
1. Upload the whole contents of the folder `sparkling-companion` to the `/wp-content/plugins/` directory
...
Currently it works only with Sparkling theme.
