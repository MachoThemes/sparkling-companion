			...
			<li class="toclone">
				...
				<p class="sparkling-media-control"
				   data-delegate-container="<?php echo esc_attr( $this->get_field_id( 'testimonials' ) . '-' . absint( $i ) ) ?>">
					<label class="logo_heading" for="<?php echo esc_attr( $this->get_field_id( 'testimonials' ) . '-' . absint( $i ) ); ?>"><?php _e( 'Author Image #', 'sparkling' ); ?>
				...
				<textarea name="<?php echo esc_attr( $this->get_field_name( 'testimonials' ) . '[testimonial][' . $i . ']' ); ?>"
