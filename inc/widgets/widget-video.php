...
class Sparkling_Video extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<hr/>
		<p><label
				for="<?php echo esc_attr( $this->get_field_id( 'video_type' ) ); ?>"><?php esc_html_e( 'Video Type ', 'sparkling' ) ?></label>
			<select name="<?php echo esc_attr( $this->get_field_name( 'video_type' ) ); ?>"
				...
				<option
					value="youtube" <?php selected( $instance['video_type'], 'youtube' ); ?>><?php _e( 'YouTube', 'sparkling' ); ?></option>
				<option
					value="upload" <?php selected( $instance['video_type'], 'upload' ); ?>><?php _e( 'Upload', 'sparkling' ); ?></option>
			</select>
		</p>
		...
		<p><label
				for="<?php echo esc_attr( $this->get_field_id( 'video_height' ) ); ?>"><?php esc_html_e( 'Video Height (in pixels): ', 'sparkling' ) ?></label>
		...
		<p class="youtube-controls">
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'youtube_id' ) ); ?>"><?php esc_html_e( 'YouTube ID: ', 'sparkling' ) ?></label>
		...
		<hr/>
		<p class="upload-controls sparkling-media-control"
		   data-delegate-container="<?php echo esc_attr( $this->get_field_id( 'video_id' ) ) ?>">
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'video_id' ) ); ?>"><?php _e( 'Video URL: ', 'sparkling' );
				?></label>
		...
		<p class="upload-controls sparkling-media-control"
		   data-delegate-container="<?php echo esc_attr( $this->get_field_id( 'image_src' ) ) ?>">
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'image_src' ) ); ?>"><?php _e( 'Placeholder: ', 'sparkling' );
				?></label>
