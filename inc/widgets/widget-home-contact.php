 ...
 * Sparkling Theme
 */
class sparkling_home_contact extends WP_Widget
{
    function __construct() {
        ...
        $widget_ops = array(
            'classname' => 'sparkling_home_contact',
            'description' => esc_html__("Sparkling FrontPage Contact Section", 'sparkling'),
            'customize_selective_refresh' => true
        );
        parent::__construct('sparkling_home_contact', esc_html__('[Sparkling] Contact Section For FrontPage', 'sparkling'), $widget_ops);
    }
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <?php
                                ...
                                if ( $phone != '' ) {
                                    echo '<p class="mb0"><strong>'.__( 'Phone :', 'sparkling' ).'</strong></p>';
                                    echo '<p class="mb32"><a href="tel:'.$phone.'">'.$phone.'</a></p>';
                                }

                                if ( $email != '' ) {
                                    echo '<p class="mb0"><strong>'.__( 'Email :', 'sparkling' ).'</strong></p>';
                                    echo '<p class="mb32"><a href="mailto:'.$email.'">'.$email.'</a></p>';
                                }

                                if ( $address != '' ) {
                                    echo '<p class="mb0"><strong>'.__( 'Address :', 'sparkling' ).'</strong></p>';
    ...
    function form($instance)
    {
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('body_content')); ?>"><?php esc_html_e('Subtitle ', 'sparkling') ?></label>
        ...
        <p class="sparkling-media-control" data-delegate-container="<?php echo esc_attr($this->get_field_id('image_src')) ?>">
            <label for="<?php echo esc_attr($this->get_field_id('image_src')); ?>"><?php _e('Background image', 'sparkling'); ?>:</label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone number ', 'sparkling') ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email ', 'sparkling') ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address ', 'sparkling') ?></label>
        ...
        <div class="checkbox_switch">
                <span class="customize-control-title onoffswitch_label">
                    <?php _e('Show social icons', 'sparkling'); ?>
                </span>
