    ...
    function form($instance)
    {
        ...
        <p class="sparkling-media-control"
           data-delegate-container="<?php echo esc_attr($this->get_field_id('image_src')) ?>">
            <label
                for="<?php echo esc_attr($this->get_field_id('image_src')); ?>"><?php _e('Image', 'sparkling');
                ?>:</label>
        ...
        <p><label
                for="<?php echo esc_attr($this->get_field_id('image_pos')); ?>"><?php esc_html_e('Image Position ', 'sparkling') ?></label>
            <select name="<?php echo esc_attr($this->get_field_name('image_pos')); ?>"
                ...
                <option
                    value="left" <?php selected($instance['image_pos'], 'left'); ?>><?php _e('Left', 'sparkling'); ?></option>
                <option
                    value="right" <?php selected($instance['image_pos'], 'right'); ?>><?php _e('Right', 'sparkling'); ?></option>
                <option
                    value="top" <?php selected($instance['image_pos'], 'top'); ?>><?php _e('Top', 'sparkling'); ?></option>
                <option
                    value="bottom" <?php selected($instance['image_pos'], 'bottom'); ?>><?php _e('Bottom', 'sparkling'); ?></option>
                <option
                    value="background-full" <?php selected($instance['image_pos'], 'background-full'); ?>><?php _e('Background Full', 'sparkling'); ?></option>
                <option
                    value="background-small" <?php selected($instance['image_pos'], 'background-small'); ?>><?php _e('Background Small', 'sparkling'); ?></option>
            </select>
        </p>

        <p><label
                for="<?php echo esc_attr($this->get_field_id('button1')); ?>"><?php esc_html_e('Button 1 Text ', 'sparkling') ?></label>
        ...
        <p><label
                for="<?php echo esc_attr($this->get_field_id('button1_link')); ?>"><?php esc_html_e('Button 1 Link ', 'sparkling') ?></label>
        ...
        <p><label
                for="<?php echo esc_attr($this->get_field_id('button2')); ?>"><?php esc_html_e('Button 2 Text ', 'sparkling') ?></label>
        ...
        <p><label
                for="<?php echo esc_attr($this->get_field_id('button2_link')); ?>"><?php esc_html_e('Button 2 Link ', 'sparkling') ?></label>
