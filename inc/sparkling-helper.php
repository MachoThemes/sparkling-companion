...
function sparkling_author_social_links( $contactmethods ) {
	// Add Twitter
...
add_filter( 'user_contactmethods', 'sparkling_author_social_links', 10, 1 );

add_action( 'wp_ajax_sparkling_get_attachment_image', 'sparkling_get_attachment_image' );
add_action( 'wp_ajax_nopriv_sparkling_get_attachment_image', 'sparkling_get_attachment_image' );
